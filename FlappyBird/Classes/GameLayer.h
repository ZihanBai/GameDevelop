 ...
 * GAME_STATUS_READY game is not start, just ready for player to start.
 * GAME_STATUS_START the game is started, and player is playing this game.
...
public:
    ...
    /**
     * During playing, after the score changed, this method will be called
     */
